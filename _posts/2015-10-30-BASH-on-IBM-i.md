...
This article will cover getting BASH (via SSH) going on the IBM i, as well as some tips and tricks of how to take advantage of this to build a comfortable BASH environment.
...
[Yips Open Source Binaries](http://yips.idevcloud.com/wiki/index.php/PASE/OpenSourceBinaries){:target="_blank"} page is a great resource for getting started
